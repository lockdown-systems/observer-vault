...
const AUTO_REPLY_MESSAGE = 'I am running Observer Vault v{version}';
...
export async function sendAutoReply(
  ...
  try {
    // Get the version from SignalContext
    let version = 'unknown';
    if (
    ...
    const autoReplyMessage = AUTO_REPLY_MESSAGE.replace('{version}', version);
